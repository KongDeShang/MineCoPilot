...
.hero {
  ...
  margin-bottom: 16px;
  color: #fff;
  background: linear-gradient(120deg, #0b3a82 0%, #1457b3 60%, #1c6bd4 100%);
}
...
.pipe-icon-1 { background: #0b3a82; }
.pipe-icon-2 { background: #3b6fb5; }
.pipe-icon-3 { background: #1c6bd4; }
.pipe-title {
  font-size: 14px;
  font-weight: 700;
  color: #0b3a82;
