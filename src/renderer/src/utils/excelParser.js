  ...
  return [
    {
      ...
      sheets: [{
        ...
        rows: [
          { '设备名称': '1号挖掘机', '设备型号': 'CAT 320D', '设备类别': '挖掘机', '所在位置': 'A矿区', '购置日期': '2021-03-15', '设备状态': '运行中' },
          { '设备名称': '2号挖掘机', '设备型号': '小松PC200', '设备类别': '挖掘机', '所在位置': 'A矿区', '购置日期': '2020-08-20', '设备状态': '运行中' },
          { '设备名称': '3号装载机', '设备型号': '柳工ZL50CN', '设备类别': '装载机', '所在位置': 'B矿区', '购置日期': '2022-01-10', '设备状态': '维保中' },
          { '设备名称': '4号挖掘机', '设备型号': '日立ZX360', '设备类别': '挖掘机', '所在位置': 'B矿区', '购置日期': '2023-05-18', '设备状态': '运行中' },
          { '设备名称': '5号矿卡', '设备型号': '三一SKT90E', '设备类别': '矿卡', '所在位置': 'A矿区', '购置日期': '2023-06-01', '设备状态': '运行中' },
          { '设备名称': '6号钻机', '设备型号': '阿特拉斯D65', '设备类别': '钻机', '所在位置': 'C矿区', '购置日期': '2019-11-20', '设备状态': '故障' },
          { '设备名称': '7号破碎机', '设备型号': '山特维克CH440', '设备类别': '破碎机', '所在位置': 'C矿区', '购置日期': '2022-09-05', '设备状态': '运行中' },
          { '设备名称': '8号矿卡', '设备型号': '卡特772G', '设备类别': '矿卡', '所在位置': 'A矿区', '购置日期': '2024-01-15', '设备状态': '运行中' }
        ],
        totalRows: 8,
        totalCols: 6
      }]
    ...
    },
    {
      ...
      sheets: [{
        ...
        rows: [
          ...
          { '配件名称': '机油滤芯', '设备型号': 'CAT通用', '数量': 8, '单价': 280, '备注': '10', '负责人': '卡特彼勒' },
          { '配件名称': '工程轮胎', '设备型号': '23.5R25', '数量': 3, '单价': 12000, '备注': '4', '负责人': '米其林' },
          { '配件名称': '合金钻头', '设备型号': 'R32-45mm', '数量': 6, '单价': 3500, '备注': '3', '负责人': '阿特拉斯' },
          { '配件名称': '高锰钢衬板', '设备型号': 'CH440专用', '数量': 2, '单价': 28000, '备注': '2', '负责人': '山特维克' },
          { '配件名称': '刹车片', '设备型号': 'SKT90E', '数量': 4, '单价': 4500, '备注': '4', '负责人': '三一重工' }
        ],
        totalRows: 6,
        totalCols: 6
      }]
